...
import AlgoraveHighlight from "@/components/sections/algorave-highlight";
  ...
  return (
    <SmoothScroll>
      ...
      <main style={{ marginTop: "100dvh" }}>
        {/* 00 — Qui suis-je ? (remplace l'ancien SkillsSection placeholder) */}
        <WhoAmISection />
 
        {/* PROJECT HIGHLIGHT — Algorave */}
        <AlgoraveHighlight />
